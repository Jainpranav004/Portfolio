...
const lines = [
  ...
  { type: "brace", content: "{" },
  { type: "kv", key: '"name"', value: '"Pranav Jain"' },
  { type: "kv", key: '"role"', value: '"Full-Stack & AI/ML Developer"' },
  { type: "kv", key: '"university"', value: '"Galgotias University"' },
  { type: "array", key: '"stack"', value: '["React", "Python", "LangChain", "AWS"]' },
  { type: "kv", key: '"open_to"', value: '"SDE / AI Intern roles"' },
